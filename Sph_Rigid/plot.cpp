...
void RigidBody::plot(int istep)
{
	string file_name;
		if(istep<10)
			file_name = "mvpART_000" + to_string(istep) + ".vtu";
		else if( istep>=10 && istep<100)
			file_name = "mvpPART_00" + to_string(istep) + ".vtu";
		else if(istep>=100 && istep<1000)
			file_name= "mvpPART_0" + to_string(istep) + ".vtu";
		else
			file_name= "mvpPART_"+ to_string(istep) + ".vtu";
